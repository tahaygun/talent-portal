...
?>
	...
	<head>
		...
		<title>Talent Portal - Posts Requests</title>
	...
	<body>
								...
								<ul class="nav navbar-nav navbar-right">
									...
									<li>
										...
										<ul class="dropdown">
											...
											<li>
												<a class="active" href="/post-requests">
													Posting Requests
												</a>
											</li>
											<li>
		...
		<section class="find-job section">
			<div class="container">
				<h2 class="section-title">Post Requests</h2>
				<div class="row">
					<div class="col-md-12">
							...
							<div class="job-list-content">
								...
								<div class="job-tag">
									...
									<div class="pull-right">
										...
										<a href="/editadmin/<?= $posting['id'] ?>" class="btn btn-common btn-sm">Edit/Delete</a>
									</div>
								</div>
							</div>
						</div>
