									...
									<form enctype="multipart/form-data" accept-charset="utf-8" action="/editnow" method="post" class="job-descript-form">
										...
										<h4>Identifies
											...
											<div class="form-group">
												...
												<option><?= isset($postinfo['identifies']) ? $postinfo['identifies'] : $postinfo['identifies'] ?></option>
												...
												<div class="form-group">
													...
													<input class="form-control" type="number" name="filled_vacancy" value="<?= isset($postinfo['filled_vacancy']) ? $postinfo['filled_vacancy'] : '' ?>" placeholder="Filled">
													<h6 style="color:#f45342;"><?= form_error('filled_vacancy') ? form_error('filled_vacancy') : '' ?></h6>
												</div>
												<div class="form-group">
